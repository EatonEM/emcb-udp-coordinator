...
var constants = {
    ...
    EMCB_UDP_HEADER_START_COORDINATOR                                 : "ETNM", // Start Byte of all Coordinator->Node requests
    EMCB_UDP_HEADER_START_NODE                                  : "ETNS", // Start Byte of all Node->Coordinator responses
    ...
    // Errors
    EMCB_UDP_ERROR_TIMEOUT                                       : "TIMEOUT",               // EmcbUDPdeviceCoordinator instance as argument
    EMCB_UDP_ERROR_PARSER                                        : "EMCB_UDP_ERROR_PARSER", // EmcbUDPdeviceCoordinator instance as argument
    ...
    EMCB_UDP_EVENT_DEVICE_DISCOVERED                             : "DEVICE_DISCOVERED",         // EmcbUDPdeviceCoordinator instance as argument
    EMCB_UDP_EVENT_DEVICE_REMOVED                                : "DEVICE_REMOVED",            // EmcbUDPdeviceCoordinator instance as argument
    EMCB_UDP_EVENT_DEVICE_IP_ADDRESS_CHANGED                     : "DEVICE_IP_ADDRESS_CHANGED", // EmcbUDPdeviceCoordinator instance as argument

    // Others
    EMCB_UDP_DEVICE_COLORS                                       : ["greenBright",
                                                                    "yellowBright",
                                                                    "blueBright",
                                                                    "magentaBright",
                                                                    "cyanBright",
                                                                    ...
                                                                    "bgMagentaBright",
                                                                    "bgCyanBright",
                                                                    "bgWhiteBright"]    // Chalk colors to help make our logs easier for a human to parse
}
