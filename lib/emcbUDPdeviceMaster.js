...
class EmcbUDPdeviceMaster extends EventEmitter {    // Any of our message codes and any EMCB_UDP_EVENT_* constants can be .on'd.
    ...
    constructor(args){
        if(args.udpKey == undefined){
            throw new Error("No udpKey provided for " + args.idDevice + " in EmcbUDPdeviceMaster constructor")
        }
        ...
        this.chalkColor         = args.chalkColor || EMCB_UDP_DEVICE_COLORS[Object.keys(this.master.devices).length];
    ...
    send(messageCode, messageData, ipAddress, udpKey, sequenceNumberOverride){
