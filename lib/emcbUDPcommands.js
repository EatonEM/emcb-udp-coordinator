...
const {
	...
	EMCB_UDP_MESSAGE_CODE_SET_CLOUD_LOGGING,
...
var self = {
    ...
    patchEvseConfigSettingsAndMode: function(options) {
        ...
        return this.send(EMCB_UDP_MESSAGE_CODE_SET_EVSE_CONFIG_SETTINGS, buf, this.ipAddress, this.udpKey)
	...
	setCloudLogging: function(enabled){
		var buf = Buffer.alloc(1);
		if(enabled === 1 || enabled === true)
			buf[0] = 1

		return this.send(EMCB_UDP_MESSAGE_CODE_SET_CLOUD_LOGGING, buf, this.ipAddress, this.udpKey)
	},
